...
export {
  C as Svg3P,
  r as SvgAddIcCall,
  l as SvgAlternateEmail,
  H as SvgAppRegistration,
  a as SvgBusiness,
  Z as SvgCall,
  V as SvgCallEnd,
  n as SvgCallMade,
  i as SvgCallMerge,
  L as SvgCallMissed,
  o as SvgCallMissedOutgoing,
  e as SvgCallReceived,
  M as SvgCallSplit,
  c as SvgCancelPresentation,
  g as SvgCellTower,
  f as SvgCellWifi,
  d as SvgChat,
  h as SvgChatBubble,
  u as SvgChatBubbleOutline,
  v as SvgClearAll,
  p as SvgCoPresent,
  w as SvgComment,
  s as SvgCommentsDisabled,
  x as SvgContactMail,
  B as SvgContactPhone,
  _ as SvgContacts,
  P as SvgDesktopAccessDisabled,
  m as SvgDialerSip,
  I as SvgDialpad,
  j as SvgDocumentScanner,
  G as SvgDomainDisabled,
  b as SvgDomainVerification,
  k as SvgDuo,
  q as SvgEmail,
  y as SvgForum,
  z as SvgForwardToInbox,
  A as SvgHourglassBottom,
  D as SvgHourglassTop,
  E as SvgHub,
  F as SvgImportContacts,
  J as SvgImportExport,
  K as SvgInvertColorsOff,
  O as SvgKey,
  N as SvgKeyOff,
  Q as SvgListAlt,
  R as SvgLiveHelp,
  ...
  U as SvgMailLock,
  W as SvgMailOutline,
  X as SvgMarkChatRead,
  Y as SvgMarkChatUnread,
  $ as SvgMarkEmailRead,
  tt as SvgMarkEmailUnread,
  Ct as SvgMarkUnreadChatAlt,
  rt as SvgMessage,
  lt as SvgMobileScreenShare,
  Ht as SvgMoreTime,
  at as SvgNat,
  Vt as SvgNoSim,
  nt as SvgPausePresentation,
  it as SvgPersonAddDisabled,
  ot as SvgPersonSearch,
  Mt as SvgPhone,
  Lt as SvgPhoneDisabled,
  et as SvgPhoneEnabled,
  Zt as SvgPhonelinkErase,
  ct as SvgPhonelinkLock,
  gt as SvgPhonelinkRing,
  ft as SvgPhonelinkSetup,
  ut as SvgPortableWifiOff,
  ht as SvgPresentToAll,
  dt as SvgPrintDisabled,
  wt as SvgQrCode,
  vt as SvgQrCode2,
  pt as SvgQrCodeScanner,
  st as SvgReadMore,
  xt as SvgRingVolume,
  Bt as SvgRssFeed,
  _t as SvgRtt,
  Pt as SvgScreenShare,
  mt as SvgSendTimeExtension,
  It as SvgSentimentSatisfiedAlt,
  jt as SvgSip,
  Gt as SvgSpeakerPhone,
  bt as SvgSpoke,
  kt as SvgStayCurrentLandscape,
  qt as SvgStayCurrentPortrait,
  yt as SvgStayPrimaryLandscape,
  zt as SvgStayPrimaryPortrait,
  At as SvgStopScreenShare,
  Dt as SvgSwapCalls,
  Et as SvgTextsms,
  Ft as SvgUnsubscribe,
  Jt as SvgVoicemail,
  Nt as SvgVpnKey,
  Kt as SvgVpnKeyOff,
  Ot as SvgWifiCalling,
};
