...
Card_demo.args = {
  ...
  description:
    "MyJio is your one stop destination for recharges, UPI & payments,\n  managing Jio devices, Movies, Music, News, Games, Quizzes & a lot\n  more.",
  image: <img src={require("./card1.jpeg")} />,
  primaryCTA: <Button size="medium">Buy Now</Button>,
  secondaryCTA: (
